...
import org.nebula_tech.itinera.controllers.UserController;
...
public class AuthenticationFilter implements HandlerInterceptor {
    ...
    private static final List<String> whitelist = Arrays.asList("/", "/user", "/user/login", "/user/register", "/user/logout");
