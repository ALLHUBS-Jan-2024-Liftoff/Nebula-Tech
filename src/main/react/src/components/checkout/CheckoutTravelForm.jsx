...
function CheckoutTravelingForm({ onHasGroupChange, onFormChange }) {
    ...
    return (
      <>
        <div className="checkout-travel-form-wrapper">
            ...
            <p className='checkout-travel-form-subtitle'>Your answer will help us give you the best customization options.</p>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              <div className='checkout-travel-form-has-group'>
                <label htmlFor="has-group-no">
                  ...
                  <div onClick={() => handleHasGroupChange("no")} className={hasGroup === 'no' ? 'selected' : ''}>I'm traveling alone</div>
                </label>
                <label htmlFor="has-group-not-sure">
                  <input name="has-group-not-sure" type="radio" value="not_sure" defaultChecked={hasGroup === 'not_sure'} />
                  <div onClick={() => handleHasGroupChange("not_sure")} className={hasGroup === 'not_sure' ? 'selected' : ''}>I'm not sure yet</div>
                </label>
                <label htmlFor="has-group-yes-already-booked">
                  ...
                  <div onClick={() => handleHasGroupChange("yes_already_booked")} className={hasGroup === 'yes_already_booked' ? 'selected' : ''}>All of my travel companions have already booked</div>
                </label>
                <label htmlFor="has-group-yes-not-booked">
                  ...
                  <div onClick={() => handleHasGroupChange("yes_not_booked")} className={hasGroup === 'yes_not_booked' ? 'selected' : ''}>Not all of my travel companions have booked</div>
                </label>
              </div>
              {validated && !hasGroup ? <span className='checkout-travel-form-error'>Please select one of the options</span> : null}
